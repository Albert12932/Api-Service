...
// DeleteQuestionHandler Удалить вопрос
...
func DeleteQuestionHandler(service *services.QuestionService) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// вызываем сервс
		err = service.DeleteQuestion(ctx, questionId)
		if err != nil {
